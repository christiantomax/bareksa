        ...
        <div class="card-body">
            ...
            <div class="row form-horizontal">
                ...
                <div class="col-sm-6">
                    ...
                    <label class="col-sm-4 col-form-label" for="suppliernama">Name<a style="color:red;">*</a></label>
                        <div class="col-sm-7">
                        <input type="text" class="form-control" id="suppliernama" placeholder="supplier Name" value="{{ $datasupplier->Nama }}">
                        </div>
                    </div>
                </div>
            </div>
            <div class="row form-horizontal">
                <div class="col-sm-6">
                    <div class="form-group row">
                    <label class="col-sm-4 col-form-label" for="suppliertelepon">Telephone 1<a style="color:red;">*</a></label>
                        <div class="col-sm-7">
                        <input type="text" class="form-control" id="suppliertelepon" placeholder="Telephone 1" value="{{ $datasupplier->Telepon }}">
                        </div>
                    </div>
                </div>
                <div class="col-sm-6">
                <div class="form-group row">
                    <div class="col-sm-1"></div>
                    <label class="col-sm-4 col-form-label" for="suppliertelepon2">Telephone 2</label>
                        <div class="col-sm-7">
                        <input type="text" class="form-control" id="suppliertelepon2" placeholder="Telephone 2" value="{{ $datasupplier->Telepon2 }}">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-6">
                ...
                <div class="form-group row">
                    <div class="col-sm-1"></div>
                    <label class="col-sm-4 col-form-label" for="supplieralamat">Address<a style="color:red;">*</a></label>
                        <div class="col-sm-7">
                        <textarea class="form-control" id="supplieralamat" placeholder="Address">{{ $datasupplier->Alamat }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
...
<script> 
    ...
    function validate(){
        if($('#suppliernama').val() == '' || $('#supplieralamat').val() == 0 || 
        $('#suppliertelepon').val() == '' || $('#supplieremail').val() == ''){
